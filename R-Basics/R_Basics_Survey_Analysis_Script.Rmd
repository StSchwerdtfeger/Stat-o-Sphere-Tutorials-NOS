...
variable responses to avoid this of happenin. The heat map should be 
self-explanatory, however, it necessary to reverse / mirror the labels in 
...
highest frequency is  also on the top. The box plot is also straight forward, 
